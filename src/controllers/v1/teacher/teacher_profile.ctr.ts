...
class ProfileCtrClass extends BaseCtr {
    ...
    async update_teacher_profile(req: IApp.IRequest , res: Response , next: NextFunction) {
        try {
            ...
            let profile_data = await UpdProfile.put_teacher_profileModule(payload, req.user)
